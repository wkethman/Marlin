...
#define X_MIN_ENDSTOP_INVERTING false // Default - false, Set to true to invert the logic of the endstop.
#define Y_MIN_ENDSTOP_INVERTING false// Default - false, Set to true to invert the logic of the endstop.
#define Z_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define X_MAX_ENDSTOP_INVERTING false // Default - false, Set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING false // Default - false, Set to true to invert the logic of the endstop.
...
#define INVERT_X_DIR true //Default - true
#define INVERT_Y_DIR true //Default - true
#define INVERT_Z_DIR false //Default - false
